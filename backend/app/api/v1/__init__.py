...
from .endpoints import auth, mfa, users, players, categories, kinesiology, injuries, matches, training, predictions, analytics, wellness, tactical, ai_tactical, notifications, email_alerts, clubs, audit, cv, imports, reports, tasks

api_router = APIRouter()
api_router.include_router(auth.router, prefix="/auth", tags=["Autenticación"])
api_router.include_router(mfa.router, prefix="/auth", tags=["Autenticación 2FA"])
api_router.include_router(users.router, prefix="/users", tags=["Usuarios"])
api_router.include_router(clubs.router, prefix="/clubs", tags=["Clubes"])
...
api_router.include_router(cv.router,    prefix="/cv",    tags=["Visión por Computadora"])
api_router.include_router(imports.router, prefix="/imports", tags=["Importaciones"])
